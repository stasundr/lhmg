...
# ADMIXTURE
	...
	ln -s /lhmg/software/admixture_linux-1.3.0/admixture /usr/local/bin
...
# PLINK
	...
	ln -s /lhmg/software/plink/plink /usr/local/bin

# EIGENSOFT
	apt-get install -y libgsl0ldbl libgfortran3; \
	cd /lhmg/software; \
	git clone https://github.com/DReichLab/EIG.git; \
	ln -s /lhmg/software/EIG/bin/convertf /usr/local/bin; \
	ln -s /lhmg/software/EIG/bin/smartpca /usr/local/bin
...
# ALDER
	...
	ln -s /lhmg/software/alder/alder  /usr/local/bin
...
# Node.js
	...
	ln -s /lhmg/software/node-v5.10.1-linux-x64/bin/node  /usr/local/bin
